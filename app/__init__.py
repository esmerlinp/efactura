...
def create_app():
        ...
        if 'user' in session:
            ...
            if company_profile:
                ...
                module_restricted = {
                    ...
                    'web_rrhh.vacation_import': 'nomina',
                    'web_rrhh.vacation_import_template': 'nomina',
                    'web_rrhh.vacation_import_upload': 'nomina',
                    'web_rrhh.vacation_import_ai_suggest': 'nomina',
                    'web_rrhh.vacation_import_process': 'nomina',
                    ...
                    'web_invoices.reports_index': 'nomina',
                    'web_invoices.report_ir18_list': 'nomina',
                    'web_invoices.report_ir18_view': 'nomina',
                    'web_invoices.report_ir18_validation': 'nomina',
                    'web_invoices.report_department': 'nomina',
                    'web_invoices.report_tss': 'nomina',
                    'web_invoices.report_comparative': 'nomina',
                    'web_invoices.report_net_payroll': 'nomina',
                    'web_invoices.report_net_payroll_export': 'nomina',
                    'web_invoices.report_isr_retentions': 'nomina',
                    'web_invoices.report_isr_retentions_export': 'nomina',
                    'web_invoices.report_what_if': 'nomina',
                    'web_invoices.dgt_index': 'nomina',
                    'web_invoices.dgt3_view': 'nomina',
                    'web_invoices.dgt3_export': 'nomina',
                    'web_invoices.dgt4_view': 'nomina',
                    ...
                    'web_invoices.dgt12_export': 'nomina',
    ...
    def add_security_headers(response):
        ...
        csp = (
            ...
            "www.paypal.com *.paypal.com *.paypalobjects.com "
            ...
            "*.paypal.com api-m.paypal.com api-m.sandbox.paypal.com; "
            "frame-src 'self' "
