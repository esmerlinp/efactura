...
def payments_new_route():
    ...
    if request.method == 'POST':
        ...
        expense_dict = {
            ...
            'cne': '',
            'tipoGastoDGII': '02',
            'includeIn606': request.form.get('includeIn606') == 'true',
            'paymentType': payment_type,
...
def company_settings():
    ...
    if request.method == 'POST':
        ...
        profile_dict.update({
            ...
            "country": request.form.get("country", existing_profile.get("country", "DO")),
            ...
            "offboardingMode": request.form.get('offboardingMode', existing_profile.get('offboardingMode', 'simple')).strip(),
            "configured": True
        })
