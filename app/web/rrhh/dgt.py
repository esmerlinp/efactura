...
def dgt3_export():
    ...
    return redirect(url_for("web_rrhh.dgt3_view"))
...
def dgt4_export():
    ...
    if fmt == "txt":
        ...
        return send_file(buffer, mimetype="application/pdf", as_attachment=True,
                         download_name=f"{filename}.pdf")
    return redirect(url_for("web_rrhh.dgt4_view"))
...
def dgt9_view():
    ...
    if request.method == "POST":
        ...
        return redirect(url_for("web_rrhh.dgt9_view"))
...
def dgt12_view():
    ...
    if request.method == "POST":
        ...
        return redirect(url_for("web_rrhh.dgt12_view"))
