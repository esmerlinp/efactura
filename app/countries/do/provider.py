...
class DOProvider(BaseCountryProvider):
    ...
    def get_payroll_rules(self) -> dict:
        from app.countries.do.payroll_rules import (
            ...
            SRL_EMPLOYER_RATE, SRL_EMPLOYER_RATES, SRL_SALARY_CAP,
            INFOTEP_EMPLOYER_RATE, INFOTEP_EMPLOYEE_RATE, INFOTEP_RATE,
            AFP_SALARY_CAP, SFS_SALARY_CAP,
            ISR_ANNUAL_TABLE, ANNUAL_EDUCATION_DEDUCTION,
            MIN_SALARY, DEPENDENTS_ADDITIONAL_RATE, DEFAULT_OVERTIME_RATE,
        ...
        return {
            ...
            "srl_employer_rates": SRL_EMPLOYER_RATES,
            "srl_salary_cap": SRL_SALARY_CAP,
            "infotep_employer_rate": INFOTEP_EMPLOYER_RATE,
            "infotep_employee_rate": INFOTEP_EMPLOYEE_RATE,
            ...
            "dependents_additional_rate": DEPENDENTS_ADDITIONAL_RATE,
    ...
    def get_labor_rules(self) -> dict:
        from app.countries.do.labor_rules import (
            ...
            TABLA_BONIFICACION,
            SALARIOS_MINIMOS,
            TARIFA_DEPENDIENTES_ADICIONALES,
        )
        return {
            ...
            "bonificacion_table": TABLA_BONIFICACION,
            "salarios_minimos": SALARIOS_MINIMOS,
            "dependents_additional_rate": TARIFA_DEPENDIENTES_ADICIONALES,
        }
