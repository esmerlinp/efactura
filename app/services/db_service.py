...
class DatabaseService:
    ...
    def get_company_profile(cls, owner_uid, company_id=None):
        ...
        return {
            ...
            "logoStoragePath": company.get("logo_storage_path", company.get("logoStoragePath", "")),
            "stampUrl": company.get("stamp_url", company.get("stampUrl", "")),
            "stampStoragePath": company.get("stamp_storage_path", company.get("stampStoragePath", "")),
            "stampBase64": company.get("stamp_base64", company.get("stampBase64", "")),
            "signatureUrl": company.get("signature_url", company.get("signatureUrl", "")),
            "signatureStoragePath": company.get("signature_storage_path", company.get("signatureStoragePath", "")),
            "signatureBase64": company.get("signature_base64", company.get("signatureBase64", "")),
    ...
    def save_company_profile(cls, owner_uid, profile_dict, upload_to_firestore=True, company_id=None):
        ...
        update_data = {
            ...
            "logo_storage_path": profile_dict.get("logoStoragePath", ""),
            "stamp_url": profile_dict.get("stampUrl", ""),
            "stamp_storage_path": profile_dict.get("stampStoragePath", ""),
            "stamp_base64": profile_dict.get("stampBase64", ""),
            "signature_url": profile_dict.get("signatureUrl", ""),
            "signature_storage_path": profile_dict.get("signatureStoragePath", ""),
            "signature_base64": profile_dict.get("signatureBase64", ""),
