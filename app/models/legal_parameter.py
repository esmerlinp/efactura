...
PARAM_TYPES = {
    ...
    "srl_employer_rates": {"type": dict, "default": {1: 0.0110, 2: 0.0115, 3: 0.0120, 4: 0.0130}},
    "srl_salary_cap": {"type": float, "default": 92892.00},
    "srl_risk_category": {"type": int, "default": 3},
    "infotep_employer_rate": {"type": float, "default": 0.01},
    "infotep_employee_rate": {"type": float, "default": 0.005},
    ...
    "isr_annual_table": {
        ...
        "default": [
            ...
            [867123.01, 999999999.0, 0.25, 79776.00],
        ]
    },
}
...
def get_default_params() -> dict:
    ...
    return {
        ...
        "srl_employer_rates": PARAM_TYPES["srl_employer_rates"]["default"],
        "srl_salary_cap": PARAM_TYPES["srl_salary_cap"]["default"],
        "srl_risk_category": PARAM_TYPES["srl_risk_category"]["default"],
        "infotep_employer_rate": PARAM_TYPES["infotep_employer_rate"]["default"],
        "infotep_employee_rate": PARAM_TYPES["infotep_employee_rate"]["default"],
        ...
        "dependents_additional_rate": PARAM_TYPES["dependents_additional_rate"]["default"],
